...
interface MenuItemCardProps {
  ...
  disableAddToCart?: boolean; // Disable add to cart (for exploring mode)
}

export const MenuItemCard: React.FC<MenuItemCardProps> = ({ item, index = 0, zonePrice, disableAddToCart = false }) => {
      ...
      <div className="flex gap-0">
        ...
        <div className="flex-1 p-4 flex flex-col justify-between min-w-0">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            {/* View Only indicator for explorers */}
            {disableAddToCart && (
              <div className="flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-xl text-white/50 text-xs">
