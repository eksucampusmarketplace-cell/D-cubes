...
export const BarDashboard: React.FC = () => {
  ...
  const handleSendMessage = useCallback(() => {
    ...
    sendStaffReply(selectedTable, chatInput.trim(), 'Bar Staff');
    setChatInput('');
    ...
    <div className="min-h-screen bg-dark flex">
      ...
      <div className="w-64 bg-dark-2 border-r border-gold/10 flex-shrink-0 flex flex-col sticky top-0 h-screen">
        <div className="p-4 border-b border-white/5">
          ...
          <p className="text-[10px] tracking-[0.15em] uppercase text-cream/30 mt-1">Bar Staff</p>
        </div>
        ...
        <div className="p-4 border-t border-white/5">
          <div className="bg-dark-3 rounded-lg p-3">
            ...
            <p className="font-display text-2xl text-gold">
              {barOrders.filter(o => o.status === 'pending' || o.status === 'confirmed').length}
            </p>
          </div>
        </div>
      </div>
